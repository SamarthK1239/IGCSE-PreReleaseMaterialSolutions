...
public class OctNov2019Prerelease {
    ...
    public static void main(String[] args) {
        ...
        //use params[2] and determining the dimensions
        ...
        if (param3.contains("1")) {
            ...
            size = 0.25 * (pi * (300 * 300));
        } else if (param3.contains("6")) {
            size = 0.25 * (pi * (450 * 450));
        } else {
            System.out.println("Sorry that is not an option. Please consult the chart again");
            System.exit(-1);
        }
        ...
        price = intPrice + (priceMultiplier * priceVolume);
